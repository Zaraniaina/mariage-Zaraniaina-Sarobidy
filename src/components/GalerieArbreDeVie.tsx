  ...
  return (
    <div className={`flex flex-col md:flex-row${reverse ? '-reverse' : ''} items-center justify-between mb-16 md:mb-20 w-full relative`}>
      ...
      <div className={`w-full md:w-5/12 ${reverse ? 'md:pr-8' : 'md:pl-8'} flex justify-center md:justify-start`}>
        <div className="w-40 h-40 md:w-48 md:h-48 lg:w-56 lg:h-56 rounded-full border-4 border-white shadow-xl overflow-hidden transform hover:scale-105 transition-all relative z-10">
...
const GalerieArbreDeVie: React.FC = () => {
  return (
    <section id="galerie" className="py-16 md:py-20 relative bg-white/60 overflow-hidden">
        ...
        <div className="relative mt-8 md:mt-12 pb-20 md:pb-24">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between w-full relative">
            ...
            <div className="w-full md:w-5/12 md:pl-8 flex justify-center md:justify-start">
              <div className="w-48 h-48 md:w-56 md:h-56 lg:w-64 lg:h-64 rounded-full border-4 border-wedding-gold p-1 bg-white shadow-2xl overflow-hidden transform hover:scale-105 transition-all relative z-10">
                <img
                  alt="Famille"
